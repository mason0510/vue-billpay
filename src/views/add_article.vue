	...
	<div class="page">
		...
		<van-form validate-first @submit="onSubmit" >
			...
			<div 
				...
				>
				<van-button class='back_btn'  color="#D9D9D9" plain >撤销删除</van-button>
				<van-button class='submit_btn'  :color="submit_ok?'#3369FF':'#D9D9D9'"   native-type="submit">保存</van-button>
			</div>
			<div 
