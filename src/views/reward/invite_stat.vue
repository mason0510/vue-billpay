<template>
    <div class="page">
        <div class="profit_page bg_white">
            <div>
                <div class="profit_title flex flex_ac">邀请注册人数</div>
                <div class="profit_list">
                    <div class="profit_li flex flex_ac" @click="jump" data-url="/reward/invite?types=invite_search">
                        <div class="profit_li_time flex_grow">累计邀请注册</div>
                        <div class="profit_li_num">{{ count }}</div>
                        <img src="/img/icons/icon_next.png" alt="" class="profit_li_icon no_shrink">
                    </div>


                    <div class="profit_li flex flex_ac"
                         v-for="(item,index) in invitations" :key='index'
                         @click="jump" data-url="/reward/invite?types=invite_info" :data-datetime='item.createdDate'>
                        <div class="profit_li_time flex_grow">{{ item.createdDate }}</div>
                        <div class="profit_li_num">{{ item.count }}</div>
                        <img src="/img/icons/icon_next.png" alt="" class="profit_li_icon no_shrink">
                    </div>
                </div>
            </div>
