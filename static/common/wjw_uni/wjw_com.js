    ...
    var project_fn = {
        ...
        back_judge_app(e) {
            ...
            if(window&&window.Service){
                ...
                // app关闭网页
                window&&window.webkit&&window.webkit.messageHandlers.closeWebview.postMessage('');
            }else{
                wx.navigateBack()
            }
        },
        ...
        // app获取当前定位_回调之页面函数
        getLocation_back(){
            console.log('app获取当前定位_回调之页面函数 arguments', arguments);
            prompt('app获取当前定位_回调之页面函数 arguments', JSON.stringify(arguments));
        },
            ...
            mapObj.plugin('AMap.Geolocation',  ()=> {
                ...
                AMap.event.addListener(geolocation, 'complete', res=>{
                    ...
                    */
                    ...
                    this.loadTip('获取当前位置经纬度成功, 解析地址 中...');
        ...
        get_member_info(e) {
            ...
            uni.wjw_http({
                ...
                */
                this.mine = res.data;
                this.mine.name=this.mine.memberName;
                this.mine.tel=this.mine.phone;
                this.mine.id=this.mine.memberId;
            })
